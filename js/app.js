...
function iniciarApp() {
    ...
    function mostrarRecetaModal(receta) {
        ...
        //Bton cerrar y favoritos
        btnFavorito= document.createElement('BUTTON')
        btnFavorito.classList.add('btn-danger','btn','col')
        btnFavorito.textContent= existeLocalStorage(idMeal) ? 'Eliminar Favorito' : 'Guardar favorito';
        ...
        btnFavorito.onclick=function () {
            ...
            if (existeLocalStorage(idMeal)) {
                ...
                MostrarToast('Eliminado Corrrectamente')
                return
            }
        ...
        btnCerrar.classList.add('btn-secondary','btn','col')
    ...
    function eliminarFavorito(id) {
        ...
        const nuevoFavorito= favoritos.filter(favoritos=>favoritos.id !== id)
